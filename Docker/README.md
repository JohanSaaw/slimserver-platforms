...
## Tags
* `latest`: the latest release version, currently v9.0.3
* `stable`: the [bug fix branch](https://github.com/LMS-Community/slimserver/tree/public/9.0) based on the latest release, currently v9.0.4
